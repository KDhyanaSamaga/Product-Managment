"""add multi tenant architecture and bill items

Revision ID: 3c1ae1757505
Revises: 
Create Date: 2026-06-05 17:28:18.030142
...
def upgrade() -> None:
    ...
    sa.Column('gst', sa.Integer(), nullable=False),
